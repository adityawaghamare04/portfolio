...
import SpecializedTechnologies from "../components/Home/SpecializedTechnologies/SpecializedTechnologies";
import SomethingIveBuilt from "../components/Home/SomethingIveBuilt/SomethingIveBuilt";
import FreelanceServices from "../components/Home/FreelanceServices/FreelanceServices";
...
export default function Home() {
  ...
  useEffect(() => {
    // this will only run if NEXT_PUBLIC_BLACKLIST_COUNTRIES is not empty
    if (!IsBlackListEmpty) {
      if (userData && process.env.NEXT_PUBLIC_BLACKLIST_COUNTRIES) {
  ...
  const meta = {
    title: "Aditya Waghamare - AI/Web3 Developer & Machine Learning Engineer",
    description: "AI/Web3 Developer | Machine Learning | National Hackathons Finalist | Next.js | Solidity | Blockchain | Finance — Passionate about AI, Web3 & Scalable Tech",
    image: "/bg-orange.png",
    type: "website",
  };
  ...
  return (
    <>
      <Head>
        ...
        <meta property="og:url" content={`https://adityawaghamare.vercel.app`} />
        <link rel="canonical" href={`https://adityawaghamare.vercel.app`} />
        <meta property="og:type" content={meta.type} />
        <meta property="og:site_name" content="Aditya Waghamare" />
        <meta property="og:description" content={meta.description} />
        <meta property="og:title" content={meta.title} />
        <meta property="og:image" content={meta.image} />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:site" content="@AdityaWaghamare" />
      ...
      {!isBlackListed ? (
        <div className="relative snap-mandatory min-h-screen bg-AAprimary w-full ">
          ...
          {context.sharedState.finishedLoading ? <SpecializedTechnologies /> : <></>}
          {context.sharedState.finishedLoading ? <SomethingIveBuilt /> : <></>}
          {context.sharedState.finishedLoading ? <FreelanceServices /> : <></>}
          {context.sharedState.finishedLoading ? <GetInTouch /> : <></>}
          {context.sharedState.finishedLoading ? (
            <Footer githubUrl={"https://github.com/adityawaghamare04/portfolio"} hideSocialsInDesktop={true} />
          ) : (
            <></>
          )}
        </div>
