    ...
    <div className="font-mono text-xs md:flex hidden flex-row items-center space-x-8 ">
      ...
      <motion.div
        ...
        transition={{
          type: "spring",
          duration: props.finishedLoading ? 0 : 1.2,
          delay: props.finishedLoading ? 0 : 1.9,
        }}
        className="text-AAsecondary"
      >
        <ReactScrollLink to="skillsSection" spy={true} smooth={true} offset={-100} duration={200}>
          &gt; 03.{" "}
          <span className="text-white  hover:cursor-pointer hover:text-AAsecondary duration-300">Skills</span>
        </ReactScrollLink>
      </motion.div>
      <motion.div
        initial={{
      ...
      <motion.div
        ...
        transition={{
          type: "spring",
          duration: props.finishedLoading ? 0 : 1.2,
          delay: props.finishedLoading ? 0 : 2.1,
        }}
        className="text-AAsecondary"
      >
        <ReactScrollLink to="freelanceServicesSection" spy={true} smooth={true} offset={-100} duration={200}>
          &gt; 05.{" "}
          <span className="text-white  hover:cursor-pointer hover:text-AAsecondary duration-300">Services</span>
        </ReactScrollLink>
      </motion.div>
      <motion.span
        initial={{
